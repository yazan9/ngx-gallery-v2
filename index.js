import { Component, ChangeDetectionStrategy, Input, Output, EventEmitter, Injectable, Renderer, ElementRef, HostListener, ChangeDetectorRef, ViewChild, HostBinding, NgModule } from '@angular/core';
...
var NgxGalleryThumbnailsComponent = /** @class */ (function () {
    ...
    function NgxGalleryThumbnailsComponent(sanitization, elementRef, helperService) {
        ...
        this.minStopIndex = 0;
        this.onActiveChange = new EventEmitter();
        this.thumbnailsScrolledLeft = new EventEmitter();
        this.index = 0;
    }
    /**
     * @param {?} changes
    ...
    NgxGalleryThumbnailsComponent.propDecorators = {
        ...
        'actions': [{ type: Input },],
        'onActiveChange': [{ type: Output },],
        'thumbnailsScrolledLeft': [{ type: Output },],
        'onMouseEnter': [{ type: HostListener, args: ['mouseenter',] },],
        'onMouseLeave': [{ type: HostListener, args: ['mouseleave',] },],
    };
...
var NgxGalleryComponent = /** @class */ (function () {
    ...
    function NgxGalleryComponent(myElement) {
        ...
        this.thumbnailsScrolledLeft = new EventEmitter();
        this.imageScrolledLeft = new EventEmitter();
     ...
     * @return {?}
     */
    NgxGalleryComponent.prototype.onThumbnailsScrolledLeft = function () {
        this.thumbnailsScrolledLeft.emit();
    };
    /**
     * @return {?}
